...
class MainWindow(QMainWindow, WindowMixin):
	...
	def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
		...
		self.auto_labeling_steps_spinner = QSpinBox()
		self.auto_labeling_steps_spinner.setValue(101)
		self.auto_labeling_steps_spinner.setRange(0,1000)
		self.auto_labeling_steps_layout = QHBoxLayout()
		self.auto_labeling_steps_layout.addWidget(self.auto_labeling_steps_label)
		self.auto_labeling_steps_layout.addWidget(self.auto_labeling_steps_spinner)
		self.auto_labeling_model_path = QLabel(get_str('auto_labeling_model_path'))
		...
		self.auto_label_widget = QListWidget()
		self.auto_label_widget.itemDoubleClicked.connect(self.file_item_double_clicked)		

		auto_label_layout = QVBoxLayout()		
		auto_label_layout.addWidget(self.train_auto_labeling_checkbox)		
		auto_label_layout.addWidget(self.use_auto_labeling_checkbox)
		auto_label_layout.addLayout(self.auto_labeling_steps_layout)
		...
		self.auto_label_dock = QDockWidget(get_str('auto_labeling'), self)
		self.auto_label_dock.setObjectName(get_str('auto_labeling_dock'))
		self.auto_label_dock.setWidget(auto_label_container)
		...
		self.addDockWidget(Qt.RightDockWidgetArea, self.auto_label_dock)
		self.file_dock.setFeatures(QDockWidget.DockWidgetFloatable)
		self.auto_label_dock.setFeatures(QDockWidget.DockWidgetFloatable)
